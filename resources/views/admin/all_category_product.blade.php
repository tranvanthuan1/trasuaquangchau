...
<div class="table-agile-info">
    ...
    <div class="table-responsive">
        <div align="center" style="color: #232B6B;  font-weight: bold;">
        <?php
      ...
      <table class="table table-striped b-t b-light">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td width="750px">{{$cate_pro ->category_name}}</td>
                ...
                {{-- <td><span class="text-ellipsis">23/3/2021</span></td> --}}
                <td>
                    <a href="{{URL::to('/edit-category-product/'.$cate_pro->category_id)}}" class="active" ui-toggle-class="">
                        <i class="fa fa-pencil-square-o text-success text-active"></i>
                    </a>
                    <a onclick="return confirm('Bạn muốn xóa nó không?')" href="{{URL::to('/delete-category-product/'.$cate_pro->category_id)}}" class="active" ui-toggle-class="">
