      ...
      <table class="table table-striped b-t b-light">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td width="750px">{{$brand_pro ->brand_name}}</td>
                ...
                <td>
                    ...
                    <a onclick="return confirm('Bạn muốn xóa nó không?')" href="{{URL::to('/delete-brand-product/'.$brand_pro->brand_id)}}" class="active" ui-toggle-class="">
